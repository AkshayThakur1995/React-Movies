...
export const fetchMovies = createAsyncThunk(
  ...
  async (term) => {
    const response = await axios.get(
      `https://www.omdbapi.com/?i=tt3896198&apikey=97084054&s=${term}`
    );
...
export const fetchMoviesShows = createAsyncThunk(
  "movies/fetchMoviesShows",
  async (term) => {
    const response = await axios.get(
      `https://www.omdbapi.com/?i=tt3896198&apikey=97084054&s=${term}&type=series`
    );
    return response.data;
  }
);
...
export const fetchMoviesOrShowsDetail = createAsyncThunk(
  ...
  async (id) => {
    const response = await axios.get(
      `https://www.omdbapi.com/?&apikey=97084054&i=${id}&plot=full`
    );
    return response.data;
  }
);
